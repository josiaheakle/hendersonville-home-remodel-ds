	...
	return (
		<PageTemplate activePage="/private-policy" isHomepage={false}>
			<div className={`section container`}>
				<h1>{buisnessTitle} Private Policy</h1>
				<p>
					Effective date: January 1, 2021
					{buisnessTitle} (“us”, “we”, or “our”) operates {siteData.url} (the
					...
					our Terms and Conditions, accessible from {siteData.url}.
				</p>
				...
				<h2>Use of Data</h2>
				<p>{buisnessTitle} uses the collected data for various purposes:</p>
				<ul>
				...
				<p>
					{buisnessTitle} will take all steps reasonably necessary to ensure
				...
				<p>
					{buisnessTitle} may disclose your Personal Data in the good faith
					belief that such action is necessary to:
				</p>
				<ul>
					<li>To comply with a legal obligation</li>
					<li>
						To protect and defend the rights or property of {buisnessTitle}
					</li>
					<li>
				...
				<p>
					Requests for service via phone and email from {buisnessTitle} are
					delivered to a local Contractor company that provides Contractor
					services in Hendersonville, TN.
				</p>
				<p>
				...
				<ul>
					<li>
						...
						please visit the Google Privacy & Terms{" "}
						<a
